...
class TorrentialRainTest extends FunSuite {
  ...
  test("El efecto funciona con las cartas de Distance") {
    ...
    P2.playCard(new Bomber)
    assertEquals(board.getPlayerSection(P2).getSiegeField(0).getStrength, 10)
    P2.playCard(new Bomber)
    assertEquals(board.getPlayerSection(P2).getSiegeField(0).getStrength, 20)
    assertEquals(board.getPlayerSection(P2).getSiegeField(1).getStrength, 20)

    P1.playCard(new Rainy)
    assertEquals(board.getPlayerSection(P1).getSiegeField(0).getStrength, 1)
    assertEquals(board.getPlayerSection(P1).getSiegeField(1).getStrength, 1)
    assertEquals(board.getPlayerSection(P2).getSiegeField(0).getStrength, 1)
    assertEquals(board.getPlayerSection(P2).getSiegeField(1).getStrength, 1)
  }
